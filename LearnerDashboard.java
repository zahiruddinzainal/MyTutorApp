...
public class LearnerDashboard extends AppCompatActivity {
    ...
    private LearnerRecyclerAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(LearnerDashboard.this);
                ...
                mAbout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent a = new Intent (LearnerDashboard.this, About.class);
                        startActivity(a);
                    }
                });
                ...
                mTutorial.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent tut = new Intent (LearnerDashboard.this, LearnerTutorial.class);
                        startActivity(tut);
                    }
                });
                ...
                mProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent pr = new Intent (LearnerDashboard.this, LearnerProfile.class);
                        startActivity(pr);
                    }
                });
        ...
        mAdapter = new LearnerRecyclerAdapter(LearnerDashboard.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(LearnerDashboard.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void sublimePicker() {
        ...
        pickerFrag.show(LearnerDashboard.this.getSupportFragmentManager(), "SUBLIME_PICKER");
    }
