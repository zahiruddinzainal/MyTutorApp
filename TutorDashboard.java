    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(TutorDashboard.this);
                ...
                mAbout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                            Intent a = new Intent (TutorDashboard.this, About.class);
                        startActivity(a);
                    }
                });
                ...
                mTutorial.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent tut = new Intent (TutorDashboard.this, TutorTutorial.class);
                        startActivity(tut);
                    }
                });
                ...
                mProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent pr = new Intent (TutorDashboard.this, TutorProfile.class);
                        startActivity(pr);
                    }
                });
        ...
        mCreate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent create = new Intent (TutorDashboard.this, TutorCreate.class);
        ...
        mAdapter = new TutorRecyclerAdapter(TutorDashboard.this, mUploads);
        ...
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(TutorDashboard.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void adminDelete(View view){
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(TutorDashboard.this, "Class deleted", Toast.LENGTH_SHORT).show();
            }
        });
